...
al.plot.imaging.subplot(imaging=imaging_in_counts)
...
al.plot.imaging.subplot(imaging=imaging_converted_to_eps)
...
al.plot.imaging.subplot(imaging=imaging_large_stamp)
...
al.plot.imaging.subplot(imaging=imaging_large_stamp_trimmed)
...
al.plot.imaging.subplot(imaging=imaging_small_stamp)
...
# al.plot.imaging.subplot(imaging=imaging_offset_centre)
...
# al.plot.imaging.subplot(imaging=imaging_recentred_pixels)
...
al.plot.imaging.subplot(imaging=imaging_noise_from_wht)
...
al.plot.imaging.subplot(imaging=imaging_with_large_psf)
...
al.plot.imaging.subplot(imaging=imaging_with_trimmed_psf)
