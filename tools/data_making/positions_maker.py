...
# Get the relative path to this file ('workspace/tools/data_making/../../', giving a relative directory of 'workspace')
...
data_path = array_util.make_and_return_path(path=path, folder_names=['data', data_type, data_name])
