...
positions = al.positions([[[0.8, 1.45], [1.78, -0.4], [-0.95, 1.38], [-0.83, -1.04]]])

# These are the positions for the example lens 'lens_sersic_sie__source_sersic__2'
# positions = al.positions([[[0.44, 0.60], [-1.4, -0.41], [0.15, -1.45]]])

# These are the positions for the example lens 'lens_sie__source_sersic__2'
# positions = al.positions([[[1.28, -1.35], [-0.5, 0.7]]])

# These are the positions for the example lens 'lens_mass__source_sersic_x2'
# positions = al.positions([[[2.16, -1.3], [-0.65, 0.45]]])
...
positions.output_to_file(positions_path=dataset_path + "positions.dat")
