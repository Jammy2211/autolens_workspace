...
"""
This pipeline fits the lens light of a strong lens using a single _EllipticalSersic_ model.
...
Phase 1:
    ...
    Fit the lens light using an _EllipticalSersic_ model, with the lens mass and source fixed to the result of the 
    previous pipeline.
