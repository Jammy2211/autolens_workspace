...
def make_pipeline(slam, settings):
    ...
    """SLaM: Set whether the disk is modeled as an `EllipticalSersic` or `EllipticalExponential`."""
    ...
    """SLaM: include a thid component, the envelope, in the model if included in the `LightSetup`."""
