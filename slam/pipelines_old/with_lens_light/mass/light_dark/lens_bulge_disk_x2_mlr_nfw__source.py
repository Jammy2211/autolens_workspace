...
Phase 1:
    ...
    Notes: Uses an interpolation pixel scale for fast `EllipticalPowerLaw` deflection angle calculations by default.
...
def make_pipeline(slam, settings):
    ...
    pipeline_name = "pipeline_mass__light_dark__bulge_disk_x2"
    ...
    lens.disk_1.centre = af.last.instance.galaxies.lens.disk_1.centre
    lens.disk_1.elliptical_comps = (
        af.last.instance.galaxies.lens.disk_1.elliptical_comps
    )
    lens.disk_1.phi = af.last.instance.galaxies.lens.disk_1.phi
    lens.disk_1.intensity = af.last.instance.galaxies.lens.disk_1.intensity
    lens.disk_1.effective_radius = (
        af.last.instance.galaxies.lens.disk_1.effective_radius
    )

    if slam.pipeline_light.disk_as_sersic:
        lens.disk.sersic_index = af.last.instance.galaxies.lens.disk.sersic_index
        lens.disk_1.sersic_index = af.last.instance.galaxies.lens.disk_1.sersic_index
    ...
    if slam.setup_light.disk_as_sersic:
    ...
    lens.disk_1.centre = af.last[-1].model.galaxies.lens.disk_1.centre
    lens.disk_1.elliptical_comps = af.last[
        -1
    ].model.galaxies.lens.disk_1.elliptical_comps
    lens.disk_1.intensity = af.last[-1].model.galaxies.lens.disk_1.intensity
    lens.disk_1.effective_radius = af.last[
        -1
    ].model.galaxies.lens.disk_1.effective_radius
    if slam.setup_light.disk_1_as_sersic:
        lens.disk_1.sersic_index = af.last[-1].model.galaxies.lens.disk_1.sersic_index

    lens.disk_1.mass_to_light_ratio = (
        phase1.result.model.galaxies.lens.disk_1.mass_to_light_ratio
    )
