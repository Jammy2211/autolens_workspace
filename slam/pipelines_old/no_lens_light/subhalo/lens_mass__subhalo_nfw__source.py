...
def make_pipeline(
    ...
    subhalo.mass.slam.redshift_source = slam.redshift_source
    ...
    subhalo_z_below.mass.slam.redshift_source = slam.redshift_source
    ...
    subhalo_z_above.mass.slam.redshift_source = slam.redshift_source
