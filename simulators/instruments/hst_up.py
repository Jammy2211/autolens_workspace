...
This script simulates _Imaging_ of a strong lens where:
 ...
 - The resolution, PSF and S/N are representative of Hubble Space Telescope _Imaging_ that has been multidrizzled to
      higher resolution.
"""
...
grid = al.GridIterate.uniform(
    shape_2d=(100, 100), pixel_scales=0.03, fractional_accuracy=0.9999
)
