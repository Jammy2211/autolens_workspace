...
'/autolens_workspace/dataset/imaging/with_lens_light/lens_gaussians_x3_source_sersic/'
"""
...
lens_galaxy = al.Galaxy(
    redshift=0.5,
    gaussian_0=al.lp.EllipticalGaussian(centre=(0.0, 0.0), intensity=30.0, sigma=1.0),
    gaussian_1=al.lp.EllipticalGaussian(centre=(0.0, 0.0), intensity=20.0, sigma=3.0),
    gaussian_2=al.lp.EllipticalGaussian(centre=(0.0, 0.0), intensity=10.0, sigma=5.0),
