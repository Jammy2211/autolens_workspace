...
ccd_data = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'multiple_hdus.fits', image_hdu=0,
                                       noise_map_path=ccd_data_path + 'multiple_hdus.fits', noise_map_hdu=1,
                                       psf_path=ccd_data_path + 'multiple_hdus.fits', psf_hdu=2, pixel_scale=0.1)
ccd_plotters.plot_ccd_subplot(ccd_data=ccd_data)
...
ccd_data_converted_to_eps = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'image.fits', pixel_scale=0.1,
                                                        noise_map_path=ccd_data_path + 'noise_map.fits',
                                                        psf_path=ccd_data_path + 'psf.fits',
...
ccd_data_large_stamp_trimmed = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'image.fits',
                                                           pixel_scale=0.1,
                                                           noise_map_path=ccd_data_path + 'noise_map.fits',
                                                           psf_path=ccd_data_path + 'psf.fits',
...
ccd_data_small_stamp = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'image.fits', pixel_scale=0.1,
                                                   noise_map_path=ccd_data_path + 'noise_map.fits',
                                                   psf_path=ccd_data_path + 'psf.fits')
...
ccd_data_small_stamp_padded = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'image.fits',
                                                          pixel_scale=0.1,
                                                          noise_map_path=ccd_data_path + 'noise_map.fits',
                                                          psf_path=ccd_data_path + 'psf.fits',
...
ccd_data_with_trimmed_psf = ccd.load_ccd_data_from_fits(image_path=ccd_data_path + 'image.fits',
                                                        pixel_scale=0.1,
                                                        noise_map_path=ccd_data_path + 'noise_map.fits',
                                                        psf_path=ccd_data_path + 'psf.fits',
