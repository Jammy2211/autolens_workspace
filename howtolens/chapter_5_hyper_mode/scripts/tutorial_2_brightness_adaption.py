...
# %%
"""
To perform brightness adaption, we use a 'binned grid' in our masked_imaging aongide binned_hyper_galaxy_images. For 
now, ignore these 'binned' quantities - I'll explain what they do at the end of the tutorial.
"""
...
introduces extra hyper-galaxy-parametersr. But the pay-off is more than worth it, as we fit our image data better 
and (typically) end up using far fewer source pixels to fit the data because we don't 'waste' pixels reconstructing 
regions of the source-plane where there is no signal.
"""
...
the pixelization can fully adapt to the source's brightest and faintest regions simultaneously.
