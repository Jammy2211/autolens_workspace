...
# subset of our data (e.g. < 5% of pixels) contributes to the majority of our likelihood (e.g. > 95% of the overall
...
# So, you're probably wondering, why can't we just change the mass model to fit the data better? Surely if we actually
...
print("Evidence using variances hyper by hyper-galaxy galaxy = ", fit.evidence)
