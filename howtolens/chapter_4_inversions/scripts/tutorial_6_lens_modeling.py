...
comprise just a few parameters we've got a much less complex non-linear parameter space to deal with. This allows us to
fit more complex mass models and ask ever more interesting scientific questions!
...
# %%
"""
When fitting such an image we now want to include the lens's light in the analysis. First, we update our mask to be 
...
significant this is going to mess with our source reconstruction and can lead to some pretty nasty systematics. 
In the next chapter, we'll learn how our adaptive analysis can prevent this residual fitting.
"""
