...
# %%
"""
Next, lets set this image up as lens data and setup a tracer using the input lens galaxy model (we don't need to 
provide the source's light profile, as we're using a mapper to reconstruct it).
"""
...
# %%
"""
This code is doing all the the same as above (setup the image, galaxies, tracer, mapper, ec.), but I have made the 
...
2) When datas using light profiles we discussed how a 'model_image' was generated by blurring them with the data's PSF. 
...
giving the source galaxy a light profile, we give it a pixelization and regularization, and pass it to a tracer.
"""
