...
provide the source's *LightProfile*, as we're using a mapper to reconstruct it).
"""
...
2) When datas using *LightProfile*s we discussed how a 'model_image' was generated by blurring them with the data's PSF. 
