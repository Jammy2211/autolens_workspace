...
# In fact, on can use the 'return_in_2d' function to return pretty much *all* grid methods in 2D. This is the default
# behaviour, and how we'll return all arrays from here on!'
...
print("deflection-angles of regular-grid pixel 0:")
