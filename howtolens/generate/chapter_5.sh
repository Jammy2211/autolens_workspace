...
export CHAPTER_PATH=$HOWTOLENS_PATH/chapter_5_hyper_mode
export SCRIPTS_PATH=$CHAPTER_PATH/scripts

echo "Removing old notebooks."
rm -rf $HOWTOLENS_PATH/dataset/chapter_5/lens*
...
# cp -r $WORKSPACE_PATH/dataset/howtolens/chapter_5 $PYAUTOLENS_PATH/howtolens/dataset
