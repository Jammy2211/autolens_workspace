...
CHAPTER_PATH=$HOWTOLENS_PATH"/chapter_4_inversions"
SCRIPTS_PATH=$CHAPTER_PATH"/scripts"

rm -rf $HOWTOLENS_PATH/chapter_4/dataset/lens*
...
cp $CHAPTER_PATH/*ipynb $PYAUTO_PATH/PyAutoLens/docs/tutorials/chapter_4_inversions/
