...
CHAPTER_PATH=$HOWTOLENS_PATH"/chapter_3_pipelines"
SCRIPTS_PATH=$CHAPTER_PATH"/scripts"

rm -rf $HOWTOLENS_PATH/chapter_3/dataset/lens*
...
cp $CHAPTER_PATH/*ipynb $PYAUTO_PATH/PyAutoLens/docs/tutorials/chapter_3_pipelines/
