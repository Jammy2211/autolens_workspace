...
search. The broader your priors, the longer it takes to search. The more detailed your non-linear search, the longer it
takes.

There isn't much else to say here - just that, once we start thinking about pipelines, we'll start linking phases
together in ways that navigate non-linear parameter spaces in an extremely efficient manner. Furthemore, in the next
tutorial, I'll teach a really neat trick to get MultiNest running *super-fast*.
