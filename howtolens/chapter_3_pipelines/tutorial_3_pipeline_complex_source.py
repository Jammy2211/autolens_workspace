...
def make_pipeline(phase_folders=None):
    ...
    phase1 = ph.LensSourcePlanePhase(
        ...
        source_galaxies=dict(source=gm.GalaxyModel(redshift=1.0, light_0=lp.EllipticalSersic)),
    ...
    phase2 = X2SourcePhase(
        ...
        lens_galaxies=dict(lens=gm.GalaxyModel(redshift=0.5, mass=mp.EllipticalIsothermal)),
        source_galaxies=dict(source=gm.GalaxyModel(redshift=1.0, light_0=lp.EllipticalExponential,
