...
def make_pipeline(phase_folders=None):
    ...
    phase1 = LeftLensPhase(
        ...
        lens_galaxies=dict(left_lens=gm.GalaxyModel(redshift=0.5, light=lp.EllipticalSersic)),
    ...
    phase2 = RightLensPhase(
        ...
        lens_galaxies=dict(right_lens=gm.GalaxyModel(redshift=0.5, light=lp.EllipticalSersic)),
        mask_function=mask_function,
        optimizer_class=nl.MultiNest)
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.left_lens.mass.centre_0 = phase_1_results.variable.lens_galaxies.left_lens.light.centre_0
            self.lens_galaxies.left_lens.mass.centre_1 = phase_1_results.variable.lens_galaxies.left_lens.light.centre_1

            self.lens_galaxies.right_lens.mass.centre_0 = phase_2_results.variable.lens_galaxies.right_lens.light.centre_0
            self.lens_galaxies.right_lens.mass.centre_1 = phase_2_results.variable.lens_galaxies.right_lens.light.centre_1

    phase3 = LensSubtractedPhase(
        phase_name='phase_3_fit_sources', phase_folders=phase_folders,
        lens_galaxies=dict(left_lens=gm.GalaxyModel(redshift=0.5, mass=mp.EllipticalIsothermal),
    ...
    class FitAllPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.left_lens.light = phase_1_results.variable.lens_galaxies.left_lens.light
            self.lens_galaxies.left_lens.mass = phase_3_results.variable.lens_galaxies.left_lens.mass
            self.lens_galaxies.right_lens.light = phase_2_results.variable.lens_galaxies.right_lens.light
            self.lens_galaxies.right_lens.mass = phase_3_results.variable.lens_galaxies.right_lens.mass
    ...
    phase4 = FitAllPhase(
        ...
        lens_galaxies=dict(left_lens=gm.GalaxyModel(redshift=0.5, light=lp.EllipticalSersic, mass=mp.EllipticalIsothermal),
                           right_lens=gm.GalaxyModel(redshift=0.5, light=lp.EllipticalSersic, mass=mp.EllipticalIsothermal)),
        source_galaxies=dict(source=gm.GalaxyModel(redshift=1.0, light=lp.EllipticalExponential)),
        optimizer_class=nl.MultiNest)
