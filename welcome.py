...
input(
    ...
    "##############################\n\n"
    ""
    "The image displayed on your screen shows a _LightProfile_, the object PyAutoLens uses to represent the luminous "
    "emission of galaxies. This emission is unlensed, which is why it looks like a fairly ordinary and boring galaxy. \n\n"
    ""
    "To perform ray-tracing, we need a _MassProfile_, which will be shown after you push [Enter]. The figures will show "
    "the convergence, gravitational potential and deflection angle map of the _MassProfile_, vital quantities for "
...
input(
    ...
    "########################\n\n"
    ""
    "By combining _LightProfile_'s and _MassProfile_'s PyAutoLens can perform ray-tracing and calculate how the path "
    "of the source galaxy's light-rays are bent by the lens galaxy as they travel to the Earth!\n\n"
    ""
    "Pushing [Enter] will show the _LightProfile_ displayed previously gravitationally lensed by the _MassProfile_."
    "\n\n"
    ""
    "[Press Enter to continue]"
    ""
