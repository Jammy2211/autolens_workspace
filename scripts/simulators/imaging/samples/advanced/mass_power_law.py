...
This script simulates a sample of `Imaging` data of 'galaxy-scale' strong lenses where:
 ...
 - The lens galaxies total mass distributions are `PowerLaw` models with `ExternalShear`'s.
...
`/autolens_workspace/dataset/imaging/sample/mass_sie__source_sersic_0`
"""
