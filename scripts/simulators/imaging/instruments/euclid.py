...
This script simulates imaging representative of Euclid, which is therefore similar to the majority of other simulator
scripts and is a good baseline of resolution and run-time.
...
simulator = al.SimulatorImaging(
    exposure_time=2260.0, psf=psf, background_sky_level=0.04424, add_poisson_noise_to_data=True
)
