...
psf = al.Kernel2D.from_gaussian(
    shape_native=(21, 21), sigma=0.025, pixel_scales=grid.pixel_scales, normalize=True
)
...
"""
The dataset can be viewed in the folder `autolens_workspace/imaging/instruments/ao`.
"""
