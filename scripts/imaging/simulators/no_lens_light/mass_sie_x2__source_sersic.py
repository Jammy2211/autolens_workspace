...
`/autolens_workspace/dataset/imaging/no_lens_light/mass_sie_x2__source_sersic`
"""
...
"""
The dataset can be viewed in the folder `autolens_workspace/imaging/no_lens_light/mass_sie_x2__source_sersic`.
"""
