...
with uniform centre priors, while extra galaxies use 10 Gaussians with centres fixed to the observed positions.
"""
# Main Lens Galaxies:
...
and higher resolution datasets it can be much higher (> 1GB going beyond 10GB).
"""
