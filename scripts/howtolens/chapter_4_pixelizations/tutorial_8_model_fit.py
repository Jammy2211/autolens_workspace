...
We use the results of search 1 to create the lens model fitted in search 2, where:
 ...
 - The source-galaxy's pixelization uses a `RectangularMagnification` mesh [0 parameters].
...
We use the results of searches 1 and 2 to create the lens model fitted in search 3, where:
 ...
 - The source-galaxy's pixelization uses a `RectangularMagnification` mesh [parameters fixed to results of search 2].
