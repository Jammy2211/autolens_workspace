"""
SLaM (Source, Light and Mass): Subhalo Detect Source Parametric
===============================================================

This example illustrates how to perform DM subhalo detection using a SLaM pipeline using light profiles for the
source galaxy.

For real data, using light profiles for the source will produce unreliable DM subhalo results. This is because
light profiles cannot accurately capture the morphology of a complex real source's. However, for simulated datasets,
using light profiles can help test different aspects of DM subhalo detection.
