...
# %%
"""
When we print this the length of this generator converted to a list of outputs we see 9 different NestedSamplerSamples 
...
# %%
"""
If we want to remove the fits of the first 2 phases and just keep the NestedSamplerSampless of the 3rd and final phase 
...
# %%
"""
As expected, this list now has only 3 NestedSamplerSampless, one for each image we fitted (note how in the bottom print
...
the advanced pipelines. In this case, the aggregator would load the NestedSamplerSampless of all fits of all phases of all 
pipelines!
...
# %%
"""
As expected, this list again has 3 NestedSamplerSampless.
"""
...
# %%
mp_vector = [samps.most_probable_vector for samps in agg_filter.values("samples")]
