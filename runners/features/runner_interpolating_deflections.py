...
# read the example pipeline 'workspace/pipelines/features/interpolating_deflections.py' for a description of how
...
pipeline = interpolating_deflections.make_pipeline(
    phase_folders=[data_type, data_name], interp_pixel_scale=0.05
)
