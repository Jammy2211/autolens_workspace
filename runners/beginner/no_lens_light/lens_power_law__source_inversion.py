...
# Using a pipeline composed of four phases we will fit an power-law mass model and source using a pixelized inversion.

# We'll use the example pipeline:
# 'autolens_workspace/pipelines/beginner/no_lens_light/lens_power_law__source_inversion.py'.
...
from pipelines.beginner.no_lens_light import lens_power_law__source_inversion

pipeline = lens_power_law__source_inversion.make_pipeline(
