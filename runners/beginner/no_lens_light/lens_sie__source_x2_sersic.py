...
# Using a pipeline composed of two phases we will fit an SIE mass model and two parametric Sersic sources.

# We'll use the example pipeline:
# 'autolens_workspace/pipelines/beginner/no_lens_light/lens_sie__source_x2_sersic.py'.
