...
dataset_name = (
    "lens_sie__subhalo_nfw__source_sersic"
...
from pipelines.hyper.no_lens_light.power_law.from_initialize import (
    lens_power_law__source_sersic,
)
from pipelines.hyper.no_lens_light.subhalo.from_power_law import (
    lens_power_law__subhalo_nfw__source_sersic,
)
...
pipeline_subhalo = lens_power_law__subhalo_nfw__source_sersic.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[dataset_label, dataset_name]
)
