...
data_type = "example"
data_name = (
    "lens_decomposed_light_dark_mass_and_x1_source"
...
pipeline_settings = pl.PipelineSettings(
    include_shear=True, align_light_dark_centre=True
)
...
from workspace.pipelines.advanced.with_lens_light.sersic.light_dark_mass.from_initialize import (
    lens_sersic_mlr_nfw_source_sersic,
)
...
pipeline_light_dark = lens_sersic_mlr_nfw_source_sersic.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)
