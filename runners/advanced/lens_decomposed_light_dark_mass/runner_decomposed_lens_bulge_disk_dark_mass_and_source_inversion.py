...
from workspace.pipelines.advanced.with_lens_light.bulge_disk.light_dark_mass.from_inversion import (
    lens_sersic_exp_mlr_nfw_source_inversion,
)
...
pipeline_power_law = lens_sersic_exp_sie_source_inversion.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)
