...
from workspace.pipelines.advanced.with_lens_light.bulge_disk.light_dark_mass.from_initialize import (
    lens_sersic_exp_mlr_nfw_source_sersic,
)
...
pipeline_power_law = lens_sersic_exp_mlr_nfw_source_sersic.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)
