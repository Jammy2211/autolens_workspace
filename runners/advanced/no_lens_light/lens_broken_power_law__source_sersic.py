...
# Using a source pipeline and a mass pipeline we will fit a broken power-law mass model and source using a
# parametric sersic.
...
# 'autolens_workspace/pipelines/advanced/no_lens_light/mass/broken_power_law/lens_broken_power_law__source.py'.
...
from pipelines.advanced.no_lens_light.mass.broken_power_law import (
    lens_broken_power_law__source,
)

pipeline_mass__broken_power_law = lens_broken_power_law__source.make_pipeline(
    setup=setup, phase_folders=["advanced", dataset_label, dataset_name]
)
...
pipeline = (
    ...
    + pipeline_mass__broken_power_law
)
