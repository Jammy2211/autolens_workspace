...
pipeline_settings = pl.PipelineSettings(include_shear=True, fix_lens_light=False)
...
pipeline_power_law = lens_sersic_pl_source_sersic.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)
