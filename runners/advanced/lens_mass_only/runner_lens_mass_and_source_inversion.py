...
from workspace.pipelines.advanced.no_lens_light.inversion.from_initialize import (
    lens_sie_source_inversion,
)
from workspace.pipelines.advanced.no_lens_light.power_law.from_inversion import (
    lens_pl_source_inversion,
)
...
pipeline_inversion = lens_sie_source_inversion.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)

pipeline_power_law = lens_pl_source_inversion.make_pipeline(
    pipeline_settings=pipeline_settings, phase_folders=[data_type, data_name]
)
