...
from workspace.pipelines.with_lens_light.sersic.initialize import lens_sersic_sie_shear_source_sersic
from workspace.pipelines.with_lens_light.sersic.inversion.from_initialize import lens_sersic_sie_shear_source_inversion
from workspace.pipelines.with_lens_light.sersic.power_law.from_inversion import lens_sersic_pl_shear_source_inversion
from workspace.pipelines.with_lens_light.sersic.subhalo.from_power_law import lens_sersic_pl_shear_subhalo_source_inversion

pipeline_initialize = lens_sersic_sie_shear_source_sersic.make_pipeline(
    phase_folders=[data_type, data_name])

pipeline_inversion = lens_sersic_sie_shear_source_inversion.make_pipeline(
    phase_folders=[data_type, data_name])

pipeline_power_law = lens_sersic_pl_shear_source_inversion.make_pipeline(
    phase_folders=[data_type, data_name])

pipeline_subhalo = lens_sersic_pl_shear_subhalo_source_inversion.make_pipeline(
    phase_folders=[data_type, data_name])

pipeline = pipeline_initialize + pipeline_inversion + pipeline_power_law + pipeline_subhalo
