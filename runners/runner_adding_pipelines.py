...
from autolens_workspace.pipelines.with_lens_light.initializers import lens_sersic_sie_source_sersic_from_init
from autolens_workspace.pipelines.with_lens_light.initializers import lens_sersic_sie_source_inversion_from_pl

pipeline_light_profile = lens_sersic_sie_source_sersic_from_init.make_pipeline(phase_folders=[data_type, data_name])
pipeline_inversion = lens_sersic_sie_source_inversion_from_pl.make_pipeline(phase_folders=[data_type, data_name])
