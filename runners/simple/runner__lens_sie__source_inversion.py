...
# strong lens analysis. To show you around, we'll load up some example instrument and run it through some of the example
...
# data_type = 'example'
# data_name = 'lens_mass__source_sersic_x2' # An example simulated image without any lens light and two source galaxies.
# pixel_scale = 0.1
#
# data_path = af.path_util.make_and_return_path_from_path_and_folder_names(path=workspace_path,
#                                                                       folder_names=['instrument', data_type, data_name])
#
# ccd_data = al.load_ccd_data_from_fits(image_path=data_path + 'image.fits',
#                                        psf_path=data_path + 'psf.fits',
#                                        noise_map_path=data_path + 'noise_map.fits',
#                                        pixel_scale=pixel_scale)
#
...
# from pipelines.simple import lens_sie__source_x2_sersic
