...
This uses the pipeline (Check it out full description of the pipeline):
 ...
 `autolens_workspace/pipelines/imaging/with_lens_light/light_parametric_disk__mass_sie__source_inversion.py`.
"""
...
`/autolens_workspace/dataset/imaging/light_sersic_exp__mass_sie__source_sersic`
"""
...
from autolens_workspace.transdimensional.pipelines.imaging.with_lens_light import (
    light_parametric__mass_total__source_inversion,
)
