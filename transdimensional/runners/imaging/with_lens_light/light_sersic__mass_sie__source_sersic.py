...
of the pipeline:
 ...
 - The source galaxy is modeled as an *EllipticlSersic*.

This uses the pipeline (Check it out full description of the pipeline):

 'autolens_workspace/pipelines/imaging/with_lens_light/light_sersic__mass_sie__source_sersic.py'.
"""
...
pipeline = light_sersic__mass_sie__source_sersic.make_pipeline(
