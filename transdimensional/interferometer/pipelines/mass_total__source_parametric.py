...
def make_pipeline(setup, settings, real_space_mask):
    ...
    if mass.cls is al.mp.EllipticalPowerLaw:
        ...
        mass.centre = phase1.result.model.galaxies.lens.mass.centre
        mass.elliptical_comps = phase1.result.model.galaxies.lens.mass.elliptical_comps
        mass.einstein_radius = phase1.result.model.galaxies.lens.mass.einstein_radius
