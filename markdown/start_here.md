> ✏️ **This page is auto-generated from [`start_here.py`](../start_here.py) — do not edit it directly.**
> It shows the example fully executed, with its real output images.
> Run it yourself via the [Python script](../start_here.py) or the [Jupyter notebook](../start_here.ipynb).
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdec3be9c40>
...
![png](start_here_files/start_here_15_0.png)
    



    
![png](start_here_files/start_here_15_1.png)
    



    
![png](start_here_files/start_here_15_2.png)
    



    
![png](start_here_files/start_here_15_3.png)
...
![png](start_here_files/start_here_19_1.png)
...
so you can check its the right software for you before going through the installation process:
 ...
 - [cluster/start_here.ipynb](https://colab.research.google.com/github/PyAutoLabs/autolens_workspace/blob/2026.9.8.1/notebooks/cluster/start_here.ipynb): Cluster scale strong lenses with 2+ lenses and 5+ source galaxies.
