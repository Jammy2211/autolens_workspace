...
# In this pipeline, we'll perform an initialization analysis which initializes a lens model (the lens's light, mass 
# and source's light) using a source with a parametric light profile. This pipeline uses three phases:
...
def make_pipeline(phase_folders=None, inner_circular_mask_radii=None, positions_threshold=None):
    ...
    pipeline_name = 'pl_init_lens_sersic_sie_source_sersic'
    ...
    phase1 = LensPhase(phase_name='phase_1_lens_light', phase_folders=phase_folders,
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def modify_image(self, image, results):
            return image - results.from_phase("phase_1_lens_light").unmasked_lens_plane_model_image

        def pass_priors(self, results):

            self.lens_galaxies.lens.mass.centre_0 = \
                results.from_phase("phase_1_lens_light").variable.lens.light.centre_0
            self.lens_galaxies.lens.mass.centre_1 = \
                results.from_phase("phase_1_lens_light").variable.lens.light.centre_1
    ...
    class LensSourcePhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.light = results.from_phase("phase_1_lens_light").variable.lens.light
