...
def make_pipeline(
    ...
    phase2 = InversionPhase(
        phase_name='phase_2_lens_sersic_exp_sie_shear_source_inversion', phase_folders=phase_folders, tag_phases=tag_phases,
        lens_galaxies=dict(lens=gm.GalaxyModel(redshift=redshift_lens, bulge=lp.EllipticalSersic,
                                               disk=lp.EllipticalExponential, mass=mp.EllipticalIsothermal,
                                               shear=mp.ExternalShear)),
        source_galaxies=dict(source=gm.GalaxyModel(redshift=redshift_source, pixelization=pix.AdaptiveMagnification,
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.light = results.from_phase('phase_2_lens_sersic_exp_sie_shear_source_inversion').\
                constant.lens_galaxies.lens

            ### Source Inversion, Inv -> Inv ###

            self.source_galaxies.source = results.from_phase('phase_2_lens_sersic_exp_sie_shear_source_inversion').\
                variable.source_galaxies.source

    phase3 = InversionPhase(
        phase_name='phase_3_lens_sersic_exp_sie_shear_refine_source_inversion', phase_folders=phase_folders, tag_phases=tag_phases,
