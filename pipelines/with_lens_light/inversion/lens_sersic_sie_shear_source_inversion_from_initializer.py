...
def make_pipeline(phase_folders=None, phase_tagging=True, sub_grid_size=2, bin_up_factor=None, positions_threshold=None,
    ...
    pipeline_name = 'pipeline_inversion_lens_sersic_sie_shear_source_inversion'
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source.regularization = results.from_phase('phase_1_initialize_inversion').variable.regularization
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass = results.from_phase('phase_2_lens_sersic_sie_shear_source_inversion').constant.lens.mass
            self.lens_galaxies.lens.shear = results.from_phase('phase_2_lens_sersic_sie_shear_source_inversion').constant.lens.shear
            self.source_galaxies.source = results.from_phase('phase_2_lens_sersic_sie_shear_source_inversion').variable.source
