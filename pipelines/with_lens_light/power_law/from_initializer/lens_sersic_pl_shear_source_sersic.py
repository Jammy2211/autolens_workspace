    ...
    class LensSourcePhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.light = \
                results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic').variable.lens.light

            ### Lens Mass, SIE -> PL ###

            self.lens_galaxies.lens.mass.centre = \
                results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic').variable.lens.mass.centre

            self.lens_galaxies.lens.mass.axis_ratio = \
                results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic').variable.lens.mass.axis_ratio

            self.lens_galaxies.lens.mass.phi = \
                results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic').variable.lens.mass.phi

            self.lens_galaxies.lens.mass.einstein_radius = \
                results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic').variable_absolute(a=0.3).lens.mass.einstein_radius
