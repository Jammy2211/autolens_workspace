...
def make_pipeline(
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_1_lens_sersic_mlr_nfw_shear_source_inversion'). \
    ...
    phase2 = InversionPhase(
        phase_name='phase_2_lens_sersic_mlr_nfw_shear_refine_source_inversion', phase_folders=phase_folders,
