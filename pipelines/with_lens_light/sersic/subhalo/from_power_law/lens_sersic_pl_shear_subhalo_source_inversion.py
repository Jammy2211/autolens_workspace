...
def make_pipeline(
    ...
    class GridPhase(af.phase.as_grid_search(phase_imaging.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source = results.from_phase('phase_2_lens_sersic_pl_shear_refine_source_inversion').\
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source = results.from_phase('phase_3_lens_sersic_pl_shear_refine_source_inversion'). \
