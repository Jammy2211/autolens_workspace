...
def make_pipeline(
        ...
        phase_folders=None, tag_phases=True, sub_grid_size=2, bin_up_factor=None, positions_threshold=None,
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_3_lens_sersic_exp_sie_source_sersic')\
        ...
        def pass_priors(self, results):
            ...
            if pl_fix_lens_light:
                ...
                self.lens_galaxies.lens.bulge = results.from_phase(
                    'phase_3_lens_sersic_exp_sie_source_sersic').constant.lens_galaxies.lens.bulge

                self.lens_galaxies.lens.disk = results.from_phase(
                    'phase_3_lens_sersic_exp_sie_source_sersic').constant.lens_galaxies.lens.disk
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = \
                results.from_phase('phase_2_lens_sersic_exp_sie_source_inversion').constant.lens_galaxies.lens
    ...
    phase3 = InversionPhase(
        phase_name='phase_3_lens_sersic_exp_sie_refine_source_inversion',
