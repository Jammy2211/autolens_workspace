...
def make_pipeline(
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source = results.from_phase('phase_3_lens_sersic_exp_sie_shear_refine_source_inversion').\
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            ### Lens Light & Mass, Sersic -> Sersic, Exp -> Exp, PL -> PL, Shear -> Shear ###

            self.lens_galaxies.lens = results.from_phase('phase_1_lens_sersic_exp_pl_shear_source_inversion').\
    ...
    phase2 = InversionPhase(
        phase_name='phase_2_lens_sersic_exp_pl_shear_refine_source_inversion', phase_folders=phase_folders, tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
                redshift=redshift_lens,
                bulge=lp.EllipticalSersic,
