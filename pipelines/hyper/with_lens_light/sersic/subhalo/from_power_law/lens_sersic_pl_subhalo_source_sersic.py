...
def make_pipeline(
    ...
    pipeline_name = "pipeline_subhalo__lens_sersic_sie_subhalo_source_sersic"
    ...
    class GridPhase(af.as_grid_search(phase_imaging.PhaseImaging)):
        ...
        def pass_priors(self, results):
            ...
            self.galaxies.lens.light = results.from_phase(
                "phase_1_lens_sersic_pl_source_sersic"
            ...
            self.galaxies.source.light.centre = (
                results.from_phase("phase_1_lens_sersic_pl_source_sersic")
