...
def make_pipeline(
    ...
    pipeline_name = "pipeline_inv__lens_sersic_sie_source_inversion"
    ...
    phase2 = InversionPhase(
        phase_name="phase_2_lens_sersic_sie_source_magnification_inversion",
        phase_folders=phase_folders,
        tag_phases=tag_phases,
        galaxies=dict(
            lens=gm.GalaxyModel(
    ...
    class InversionPhase(phase_imaging.PhaseImaging):
        def pass_priors(self, results):
            ...
            self.galaxies.lens = results.from_phase(
                "phase_2_lens_sersic_sie_source_magnification_inversion"
            ).constant.galaxies.lens
    ...
    phase4 = InversionPhase(
        phase_name="phase_4_lens_sersic_sie_source_inversion",
        phase_folders=phase_folders,
        tag_phases=tag_phases,
        galaxies=dict(
            lens=gm.GalaxyModel(
