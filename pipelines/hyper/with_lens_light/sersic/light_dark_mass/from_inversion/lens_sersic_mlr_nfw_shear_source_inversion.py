    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            if pl_hyper_galaxies:
                ...
                self.lens_galaxies.lens.hyper_galaxy = results.from_phase('phase_2_lens_sie_shear_source_inversion').hyper_galaxy. \
                    constant.lens_galaxies.lens.hyper_galaxy

                self.source_galaxies.source.hyper_galaxy = results.from_phase('phase_2_lens_sie_shear_source_inversion').hyper_galaxy. \
