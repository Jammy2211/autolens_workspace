...
# 'pipelines/with_lens_light/initialize/lens_sersic_sie_shear_source_sersic_from_init.py'.
...
def make_pipeline(
    ...
    pipeline_name = 'pipeline_ldm__lens_sersic_mlr_nfw_shear_source_sersic'
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            if pl_align_light_dark_centre:
                ...
                self.lens_galaxies.lens.dark.centre = results.from_phase('phase_3_lens_sersic_sie_shear_source_sersic'). \
    ...
    phase1 = LensSourcePhase(
        phase_name='phase_1_lens_sersic_mlr_nfw_shear_source_sersic', phase_folders=phase_folders, tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
