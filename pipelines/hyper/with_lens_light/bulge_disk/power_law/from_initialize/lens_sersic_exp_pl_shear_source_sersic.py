...
# Previous Pipelines: with_lens_light/initialize/lens_sersic_exp_sie_shear_source_sersic.py
# Prior Passing: None
...
def make_pipeline(
    ...
    pipeline_name = 'pipeline_pl__lens_sersic_exp_pl_shear_source_sersic'
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').\
                variable_absolute(a=0.05).lens_galaxies.lens.mass.centre

            self.lens_galaxies.lens.mass.axis_ratio = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').\
                variable.lens_galaxies.lens.mass.axis_ratio

            self.lens_galaxies.lens.mass.phi = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').\
                variable.lens_galaxies.lens.mass.phi

            self.lens_galaxies.lens.mass.einstein_radius = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').\
            ...
            if pl_hyper_galaxies:
                ...
                self.lens_galaxies.lens.hyper_galaxy = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').hyper_galaxy. \
                    constant.lens_galaxies.lens.hyper_galaxy

                self.source_galaxies.source.hyper_galaxy = results.from_phase('phase_3_lens_sersic_exp_sie_shear_source_sersic').hyper_galaxy. \
                    constant.source_galaxies.source.hyper_galaxy

    phase1 = LensSourcePhase(
        phase_name='phase_1_lens_sersic_exp_pl_shear_source_sersic', phase_folders=phase_folders, tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
