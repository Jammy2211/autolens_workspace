    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            if pl_hyper_galaxies:
                ...
                self.source_galaxies.source.hyper_galaxy = results.from_phase('phase_2_lens_sie_shear_source_sersic').hyper_galaxy. \
                    constant.source_galaxies.source.hyper_galaxy

    phase3 = LensSourcePhase(
        phase_name='phase_3_lens_sersic_exp_sie_shear_source_sersic', phase_folders=phase_folders, tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
                redshift=redshift_lens,
                bulge=lp.EllipticalSersic,
