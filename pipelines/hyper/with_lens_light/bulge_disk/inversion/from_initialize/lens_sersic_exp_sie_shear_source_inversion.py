...
def make_pipeline(
    ...
    phase2 = InversionPhase(
        phase_name="phase_2_lens_sersic_exp_sie_shear_source_magnification_inversion",
        phase_folders=phase_folders,
        tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase(
                "phase_2_lens_sersic_exp_sie_shear_source_magnification_inversion"
            ).constant.lens_galaxies.lens
    ...
    phase4 = InversionPhase(
        phase_name="phase_4_lens_sersic_exp_sie_shear_source_inversion",
        phase_folders=phase_folders,
        tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
