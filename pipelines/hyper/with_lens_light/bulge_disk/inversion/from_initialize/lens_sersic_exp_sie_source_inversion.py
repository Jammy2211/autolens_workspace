    ...
    class InversionPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            if pl_fix_lens_light:
                ...
                self.lens_galaxies.lens.bulge = results.from_phase('phase_3_lens_sersic_exp_sie_source_sersic').\
                    constant.lens_galaxies.lens.bulge

                self.lens_galaxies.lens.disk = results.from_phase('phase_3_lens_sersic_exp_sie_source_sersic').\
