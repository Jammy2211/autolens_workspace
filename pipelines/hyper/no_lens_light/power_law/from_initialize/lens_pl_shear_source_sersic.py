...
# ''pipelines/no_lens_light/initialize/lens_sie_shear_source_sersic_from_init.py'.
...
# Previous Pipelines: no_lens_light/initialize/lens_sie_shear_source_sersic_from_init.py
# Prior Passing: None
...
def make_pipeline(
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_pl_shear_source_sersic",
