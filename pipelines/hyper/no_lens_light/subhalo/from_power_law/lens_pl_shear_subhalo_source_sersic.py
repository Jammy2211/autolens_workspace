...
def make_pipeline(
    ...
    class SubhaloPhase(phase_imaging.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.subhalo.mass.centre = results.from_phase('phase_1_subhalo_search').best_result.\
                variable_absolute(a=0.3).lens_galaxies.subhalo.mass.centre

            self.lens_galaxies.subhalo.mass.kappa_s = results.from_phase('phase_1_subhalo_search').best_result.\
                variable_relative(r=0.5).lens_galaxies.subhalo.mass.kappa_s

            self.lens_galaxies.subhalo.mass.scale_radius = results.from_phase('phase_1_subhalo_search').best_result.\
