...
def make_pipeline(
    ...
    class GridPhase(af.phase.as_grid_search(phase_imaging.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.source_galaxies.source = results.from_phase('phase_1_lens_pl_shear_source_inversion').inversion.\
            ...
            if pl_hyper_galaxies:
                ...
                self.source_galaxies.source.hyper_galaxy = results.from_phase('phase_1_lens_pl_shear_source_inversion').hyper_galaxy. \
