...
"""
In this pipeline, we fit the a strong lens using a Sersic *LightProfile*, SIE mass proflie and a source which uses an
inversion.
...
def make_pipeline(
    ...
    phase5 = al.PhaseImaging(
        ...
        settings=settings,
        search=af.DynestyStatic(n_live_points=60, sampling_efficiency=0.4),
    )
