...
# 1) initialize/lens_sersic_sie_source_sersic_from_init.py (phases 1->3)
# 2) initialize/lens_sersic_sie_source_inversion_from_pipeline.py (phases 4->5)
...
def make_pipeline(
    ...
    phase5 = InversionPhase(
        phase_name="phase_5_lens_sersic_sie_shear_source_inversion",
        phase_folders=phase_folders,
        tag_phases=tag_phases,
        lens_galaxies=dict(
            lens=gm.GalaxyModel(
