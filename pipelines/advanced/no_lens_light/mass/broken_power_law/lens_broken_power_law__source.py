...
def make_pipeline(
    ...
    setup.set_mass_type(mass_type="broken_power_law")
    ...
    mass.inner_slope = af.UniformPrior(0.0, 3.0)
    mass.outer_slope = af.UniformPrior(0.0, 3.0)
    mass.add_assertion(mass.inner_slope < mass.outer_slope)
