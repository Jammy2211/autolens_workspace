...
# pipeline follows on from the source__parametric pipeline
# 'pipelines/with_lens_light/source__parametric/lens__bulge_disk_sie__source_sersic.py'.
...
# Description: Fit the lens light and mass model as a decomposed light and dark matter profile, using a
...
# Previous Pipelines: with_lens_light/sersic/source__parametric/lens_bulge_disk_sie__source_sersic.py
# Prior Passing: None
...
# Description: Fit the lens light and mass model as a decomposed light and dark matter profile, using a
#              parametric Sersic light profile for the source. The lens light profile is model.
# Lens Light & Mass: EllipticalSersic + EllipticalExponential
# Lens Mass: SphericalNFW + (ExternalShear)
# Source Light: EllipticalSersic
# Previous Pipelines: with_lens_light/sersic/source__parametric/lens_bulge_disk_sie__source_sersic.py
...
def make_pipeline(
    ...
    # In phase 1, we fit the lens galaxy's light and mass and one source galaxy using the results of phase 1 as
    # initialization
