...
def make_pipeline(
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.bulge = results.from_phase(
                "phase_3_lens_sersic_exp_sie_shear_source_sersic"
            ...
            self.lens_galaxies.lens.mass.centre = (
                results.from_phase("phase_3_lens_sersic_exp_sie_shear_source_sersic")
                .variable_absolute(a=0.05)
                .lens_galaxies.lens.mass.centre
            )
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_sersic_exp_pl_shear_source_sersic",
