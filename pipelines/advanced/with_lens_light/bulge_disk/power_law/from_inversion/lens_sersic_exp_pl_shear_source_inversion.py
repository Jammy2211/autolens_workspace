...
def make_pipeline(
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.bulge = results.from_phase(
                "phase_2_lens_sersic_exp_sie_shear_source_inversion"
            ...
            self.lens_galaxies.lens.mass.centre = (
                results.from_phase("phase_2_lens_sersic_exp_sie_shear_source_inversion")
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_sersic_exp_pl_shear_source_inversion",
