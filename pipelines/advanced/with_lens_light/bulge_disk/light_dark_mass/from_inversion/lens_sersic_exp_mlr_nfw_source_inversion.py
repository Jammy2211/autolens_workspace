...
# inversion pipeline 'pipelines/with_lens_light/inversion/from_initialize/lens_sersic_exp_sie_source_inversion.py'.
...
# Previous Pipelines: with_lens_light/bulge_disk/inversion/from_initialize/lens_sersic_exp_sieexp_source_inversion.py
...
def make_pipeline(
    ...
    pipeline_name = "pipeline_ldm__lens_sersic_exp_mlr_nfw_source_inversion"
    ...
    class LensSourcePhase(phase_imaging.PhaseImaging):
        def pass_priors(self, results):
            ...
            self.galaxies.lens.shear = results.from_phase(
                "phase_2_lens_sersic_exp_sie_source_inversion"
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_sersic_exp_mlr_nfw_source_inversion",
