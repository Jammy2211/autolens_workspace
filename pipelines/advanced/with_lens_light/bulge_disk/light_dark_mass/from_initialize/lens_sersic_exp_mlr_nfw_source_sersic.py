...
# 'pipelines/with_lens_light/initialize/lens_sersic_exp_sie_source_sersic.py'.
...
# Previous Pipelines: with_lens_light/sersic/initialize/lens_sersic_exp_sie_source_sersic.py
# Prior Passing: None
...
def make_pipeline(
    ...
    pipeline_name = "pipeline_pl__lens_sersic_exp_mlr_nfw_source_sersic"
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_sersic_exp_mlr_nfw_source_sersic",
