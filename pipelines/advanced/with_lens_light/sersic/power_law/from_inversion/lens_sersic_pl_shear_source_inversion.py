...
def make_pipeline(
    ...
    class LensSourcePhase(phase_imaging.LensSourcePlanePhase):
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.light = results.from_phase(
                "phase_2_lens_sersic_sie_shear_source_inversion"
            ).variable.lens_galaxies.light

            ### Lens Mass, SIE -> Powerlaw ###

            self.lens_galaxies.lens.mass.centre = (
                results.from_phase("phase_2_lens_sersic_sie_shear_source_inversion")
    ...
    phase1 = LensSourcePhase(
        phase_name="phase_1_lens_sersic_pl_shear_source_inversion",
