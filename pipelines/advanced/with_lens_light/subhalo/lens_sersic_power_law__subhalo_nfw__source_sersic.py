...
# Subhalo: SphericalTruncatedNFWChallenge
# Previous Pipelines: source/parametric/lens_sie__source_sersic.py
# Prior Passing: Lens light and mass (model -> previous pipeline), source light and subhalo mass (model -> phase 2).
# Notes: None
...
def make_pipeline(
    ...
    pipeline_name = (
        "pipeline_subhalo_hyper__lens_sersic_sie__subhalo_nfw__source_" + source_tag
    )
