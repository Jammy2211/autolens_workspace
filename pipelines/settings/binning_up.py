...
"""
In this pipeline, we'll demonstrate binning up - which allows us to fit a binned up version of an image in a phase of
...
Fit the lens mass model and source _LightProfile_ using x1 source with a bin up factor of x2.
...
def make_pipeline(folders=None, settings=al.PhaseSettingsImaging(), bin_up_factor=1):

    """SETUP PIPELINE & PHASE NAMES, TAGS AND PATHS"""

    pipeline_name = "pipeline__settings__binning_up"
    ...
    phase1 = al.PhaseImaging(
        ...
        settings=settings.edit(bin_up_factor=bin_up_factor),
    )
