...
Fit the lens mass model and source *LightProfile* using x1 source with a bin up factor of x2.
...
def make_pipeline(
    phase_folders=None, settings=al.PhaseSettingsImaging(), bin_up_factor=1
):
