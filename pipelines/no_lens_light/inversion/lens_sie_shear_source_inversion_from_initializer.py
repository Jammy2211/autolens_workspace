...
# Description: Refine the lens mass model using a source inversion.
# Lens Mass: EllipitcalIsothermal + ExternalShear/
# Source Light: AdaptiveMagnification + Constant
# Previous Pipelines: initializers/lens_sie_shear_source_sersic_from_init.py
...
# Description: Refine the source inversion using this lens mass model.
# Lens Mass: EllipitcalIsothermal + ExternalShear
# Source Light: AdaptiveMagnification + Constant
...
def make_pipeline(phase_folders=None, phase_tagging=True, sub_grid_size=2, bin_up_factor=None, positions_threshold=None,
    ...
    pipeline_name = 'pipeline_inversion_lens_sie_shear_source_inversion'
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.shear = results.from_phase('phase_1_lens_sie_shear_source_sersic').constant.lens.shear
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass = results.from_phase('phase_1_lens_sie_shear_source_sersic').variable.lens.mass
            self.lens_galaxies.lens.shear = results.from_phase('phase_1_lens_sie_shear_source_sersic').variable.lens.shear
            self.source_galaxies.source.pixelization = results.from_phase('phase_1_initialize_inversion').constant.source.pixelization
            self.source_galaxies.source.regularization = results.from_phase('phase_1_initialize_inversion').variable.source.regularization
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass = results.from_phase('phase_2_lens_sie_shear_source_inversion').constant.lens.mass
            self.lens_galaxies.lens.shear = results.from_phase('phase_2_lens_sie_shear_source_inversion').constant.lens.shear
