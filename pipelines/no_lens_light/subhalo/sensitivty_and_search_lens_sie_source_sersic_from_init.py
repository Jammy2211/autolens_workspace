...
# Prior Passing: Lens mass, source light, (constant -> previous pipline).
...
def make_pipeline(phase_folders=None, interp_pixel_scale=0.05):
    ...
    pipeline_name = 'pipeline_subhalo_sensitivity_and_search_lens_sie_source_sersic'
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            effective_radius_mean = results.from_phase('phase_1_source').constant.source.light.effective_radius
            sersic_index_mean = results.from_phase('phase_1_source').constant.source.light.sersic_index
            axis_ratio_mean = results.from_phase('phase_1_source').constant.source.light.axis_ratio
            phi_mean = results.from_phase('phase_1_source').constant.source.light.phi
