...
def make_pipeline(phase_folders=None):
    ...
    phase1 = LensPhase(phase_name='phase_1_use_inner_radii_input', phase_folders=phase_folders,
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def modify_image(self, image, results):
            return image - results.from_phase('phase_1_use_inner_radii_input').unmasked_lens_plane_model_image

        def pass_priors(self, results):

            self.lens_galaxies.lens.mass.centre_0 = \
                results.from_phase('phase_1_use_inner_radii_input').variable.lens.light.centre_0
            self.lens_galaxies.lens.mass.centre_1 = \
                results.from_phase('phase_1_use_inner_radii_input').variable.lens.light.centre_1

    phase2 = LensSubtractedPhase(phase_name='phase_2_source_custom_mask_and_positions', phase_folders=phase_folders,
