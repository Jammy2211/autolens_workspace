...
def make_pipeline(phase_folders=None):
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass = results.from_phase('phase_1_x1_source').variable.lens.mass
            self.lens_galaxies.lens.shear = results.from_phase('phase_1_x1_source').variable.lens.shear
