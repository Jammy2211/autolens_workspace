...
# %%
"""
To begin lets load the strong lens dataset 'lens_sersic_mlr_nfw__source_sersic' 'from .fits files, which is the dataset we will
...
The phase_name and phase_folders inputs below specify the path of the results in the output folder:  
    ...
    '/autolens_workspace/output/examples/phase__lens_sersic_mlr_nfw__source_sersic'.
"""
