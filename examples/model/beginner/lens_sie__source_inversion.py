...
In this example script, we will fit imaging of a strong lens system where:
 ...
 - The source galaxy's surface-brightness is fitted with an _Inversion_.
...
# %%
"""
Load the strong lens dataset 'lens_sie__source_sersic' 'from .fits files, which is the dataset we will
