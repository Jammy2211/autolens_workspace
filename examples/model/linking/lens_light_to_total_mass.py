...
search = af.DynestyStatic(
    path_prefix=path.join("examples", "linking", "lens_light_to_total_mass"),
    name="phase[1]",
    n_live_points=50,
)
...
The `name` and `path_prefix` below specify the path where results are stored in the output folder:  
 ...
 `/autolens_workspace/output/examples/linking/lens_light_to_total_mass/light_sersic_exp__mass_sie__source_sersic/phase[1]`.
"""
...
The `name` and `path_prefix` below specify the path where results are stored in the output folder:  
 ...
 `/autolens_workspace/output/examples/linking/lens_light_to_total_mass/light_sersic_exp__mass_sie__source_sersic/phase[2]`.
