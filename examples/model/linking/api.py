...
In phase 1, we again use _Dynesty_ however we set a new input parameter the 'evidence_tolerance'. This is essentially
the stopping criteria of _Dynesty_, where high values means that it stops sampling earlier, at the expense of less
...
We can use fewer live points than we did in the beginner tutorials, given that prior linking now informs _Dynesty_ 
