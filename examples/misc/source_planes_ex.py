...
dataset_path = f"{workspace_path}/examples/misc/cluster_data_for_autolens"

imaging = al.Imaging.from_fits(
    image_path=f"{dataset_path}/image.fits",
    psf_path=f"{dataset_path}/psf.fits",
    noise_map_path=f"{dataset_path}/noisemap.fits",
    pixel_scales=0.1,
)
...
deflections_y = al.Array.from_fits(
    file_path=f"{workspace_path}/examples/misc/cluster_data_for_autolens/deflections_y.fits",
    pixel_scales=imaging.pixel_scales,
)
deflections_x = al.Array.from_fits(
    file_path=f"{workspace_path}/examples/misc/cluster_data_for_autolens/deflections_x.fits",
    pixel_scales=imaging.pixel_scales,
)
...
grid = al.Grid.from_fits(
    file_path=f"{workspace_path}/examples/misc/cluster_data_for_autolens/grid.fits",
    pixel_scales=imaging.pixel_scales,
)
aplt.Grid(grid=grid)
...
aplt.Grid(grid=grid, axis_limits=[0.3, 0.35, -1.85, -1.65])

print(imaging.shape_2d)
